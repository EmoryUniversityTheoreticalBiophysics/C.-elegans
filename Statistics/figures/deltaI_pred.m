...
% fig2 = gcf;
fig2.Units = 'inches'
fig2.Position = [2 2 7.5 2.69];
fig2.PaperUnits = 'inches';
fig2.PaperPosition = [0 0 7.5 2.79];
fig2.PaperSize = [7.5 2.79];


subplot(1,2,1)
errorbar(meanI,mean_Idiff_i_bin,std_Idiff_i_bin2,'s','LineWidth',1,'MarkerSize',2)
xlabel('Actual laser current of control dataset (mA)','FontSize',7)
ylabel('Difference of Predicted laser current (mA)','FontSize',7)
...
subplot(1,2,2)
errorbar(meanI,mean_Idiff_m_bin,std_Idiff_m_bin2,'s','LineWidth',1,'MarkerSize',2)
