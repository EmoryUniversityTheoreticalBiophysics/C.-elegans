...
filename3 = "RANDOMocr2osm9ocr1_data_CVel_7_shortprediction"
#filename3 = "RANDOMocr2osm9ocr1_data_CVel_shortprediction"
data3 <- readMat(file.path(paste(filename3,".mat",sep="")))

threshold = 1000

x1 = data1$predI[data1$I<threshold,]
y1 = data1$I[data1$I<threshold]

x2 = data2$predI[data2$I<threshold,]
y2 = data2$I[data2$I<threshold]

x3 = data3$predI[data3$I<threshold,]
y3 = data3$I[data3$I<threshold]


################################
ma#num of bootstrap resamples
numb <- 5000
...
writeMat(paste("Bootstrap_AvsP7_",threshold,".mat",sep=""),SDbeta3=SDbeta3,meanbeta3=meanbeta3,SDbeta2=SDbeta2,meanbeta2=meanbeta2,meanbeta1=meanbeta1,SDbeta1=SDbeta1,beta1=beta1,beta2=beta2,beta3=beta3, c1=c1,c2=c2,c3=c3,res1=res1,res2=res2,res3=res3,Ic=y1,Ii=y2,Im=y3,predIc=x1,predIi=x2,predIm=x3)
